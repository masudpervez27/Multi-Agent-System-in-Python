...
class WriteArticleValidatorAgent(AgentBase):
    ...
    def execute(self, topic, article):
        system_message = "You are an expert AI assistant that validate research articles."
        user_content = ("Given the topic and the article, assess whether the article comprehensively covers the topic, follows a logica structure, and maintains academic standards.\n"
