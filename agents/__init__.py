...
from .sanitizer_data_validator_agent import SanitizeDataValidatorAgent
...
class AgentManager:
    def __init__(self, max_retries=2, verbose=True):
        self.agents = {
            ...
            "sanitizer_data_validator_agent": SanitizeDataValidatorAgent(max_retries=max_retries, verbose=verbose),
